...
| Asked for | Status |
|---|---|
| **Image** | **Absent.** No `images`, no `imageFileIds`, no `thumbnail`. And gap **D2** applies even if there were: *"This service resolves no file URLs"* ([ADR-008 D-6](../../../docs/ADR-008-VENDOR-MANAGEMENT.md)) — an id alone renders nothing |
